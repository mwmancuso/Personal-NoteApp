...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Tokens', fields ['token']
        db.create_unique('authentication_tokens', ['token'])


    def backwards(self, orm):
        # Removing unique constraint on 'Tokens', fields ['token']
        db.delete_unique('authentication_tokens', ['token'])
